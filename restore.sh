...
cd /opt/glassfish3/glassfish/nodes/localhost-domain1/ && mkdir instance1-gs2c/ && mkdir instance1-userservice/ && mkdir instance1-dataexportapi/ && mkdir instance1-inwardservice/ && mkdir instance1-inward/ && mkdir instance1-system-service/ && mkdir instance1-cis/ && mkdir instance1-fin/ && mkdir instance1-cashier/ && instance1-gms && mkdir instance1-bingoengine/
