...
asadmin --secure --user admin --passwordfile /glassfish.passwords start-local-instance --node localhost-domain1 --sync full instance1-userservice
asadmin --secure --user admin --passwordfile /glassfish.passwords start-local-instance --node localhost-domain1 --sync full instance1-gms
